...
category: howto
permalink: /docs/0.7.x/howto/using_plugins.html
---
...
If you're interested in using a plugin popularized by the AMD Specification, please read the [how-to for AMD](/docs/0.7.x/howto/amd.html).
...
Start with the [Inject.addFetchRule()](/docs/0.7.x/api/inject.addfetchrule.html) API. This allows you to define custom rules for fetching content. Coupled with [Inject.addContentRule()](/docs/0.7.x/api/inject.addcontentrule.html), you can easily transform any file into JavaScript-ready code for use in a module.
