...
category: howto
permalink: /docs/0.7.x/howto/resolving_modules.html
---
...
The exports from `program.js` will contain `one`, `two`, and `three`. Even if you adjust the URL in Inject using a function like [Inject.addFileRule](/docs/0.7.x/api/inject.addfilerule.html), the module's IDs will continue to map as expected.
