...
version: 0.7.x
title: define
permalink: /docs/0.7.x/amd/define.html
---
...
The define method is the main AMD entry point when using the [Asynchronous Module Definition](/docs/0.7.x/howto/amd.html) format.
