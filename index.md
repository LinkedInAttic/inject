...
* [easyXDM](http://easyxdm.net/): Cross Domain Communication
* [lscache](https://github.com/pamelafox/lscache): LocalStorage Cache Provider
* [link.js](https://github.com/sebmarkbage/link.js): dependency extraction (from their src/Library/link.js)
* [GoWithTheFlow.js](https://github.com/jeromeetienne/gowiththeflow.js): simple flow control
* (and a whole lot of [npm](https://npmjs.org/) related things for development)